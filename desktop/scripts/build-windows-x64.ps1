...
function Get-StagedArtifactName {
  ...
  switch -Regex ($ArtifactName) {
    ...
    '\.msi\.zip\.sig$' { return "AiYo_${appVersion}_windows_x64_msi.msi.zip.sig" }
    '\.msi\.zip$' { return "AiYo_${appVersion}_windows_x64_msi.msi.zip" }
    '\.msi\.sig$' { return "AiYo_${appVersion}_windows_x64_msi.msi.sig" }
    '\.msi$' { return "AiYo_${appVersion}_windows_x64_msi.msi" }
