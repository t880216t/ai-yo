...
<p align="center">
  <img src="docs/images/app-icon.png" alt="AiYo" width="240">
</p>

<div align="center">

[![GitHub Stars](https://img.shields.io/github/stars/t880216t/ai-yo?style=social)](https://github.com/t880216t/ai-yo/stargazers)
[![GitHub Forks](https://img.shields.io/github/forks/t880216t/ai-yo?style=social)](https://github.com/t880216t/ai-yo/network/members)
[![GitHub Issues](https://img.shields.io/github/issues/t880216t/ai-yo)](https://github.com/t880216t/ai-yo/issues)
[![GitHub Pull Requests](https://img.shields.io/github/issues-pr/t880216t/ai-yo)](https://github.com/t880216t/ai-yo/pulls)
[![License](https://img.shields.io/github/license/t880216t/ai-yo)](https://github.com/t880216t/ai-yo/blob/main/LICENSE)
[![中文](https://img.shields.io/badge/🇨🇳_中文-当前-blue)](README.md)
[![English](https://img.shields.io/badge/🇺🇸_English-Available-green)](README.en.md)

</div>

AiYo 是一个**桌面端 AI 编程工作台**：把会话、多项目、分支 / Worktree、右侧代码改动、代码 Diff、权限审批、模型提供商、Computer Use、H5 远程访问、IM 接入和定时任务集中到一个 macOS / Windows APP 里。
...
AiYo 的桌面端把会话、多项目、分支 / Worktree、右侧代码改动、代码 Diff、权限确认、提供商配置和远程入口集中到一个图形化工作台里，适合不想长期停留在终端里的日常开发工作流。

<p align="center">
  <a href="https://github.com/t880216t/ai-yo/releases"><img src="https://img.shields.io/badge/⬇_下载桌面端-macOS_%7C_Windows-FF7A00?style=for-the-badge" alt="下载桌面端"></a>
  &nbsp;
...
1. 前往 [Releases](https://github.com/t880216t/ai-yo/releases) 下载 macOS 或 Windows 桌面端安装包。
...
如果这个项目对您有帮助，请给个 ⭐ Star 支持一下，让更多的人看到 AiYo！

<a href="https://www.star-history.com/#t880216t/ai-yo&Date">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=t880216t/ai-yo&type=Date&theme=dark" />
    <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=t880216t/ai-yo&type=Date" />
    <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=t880216t/ai-yo&type=Date" />
  </picture>
</a>
